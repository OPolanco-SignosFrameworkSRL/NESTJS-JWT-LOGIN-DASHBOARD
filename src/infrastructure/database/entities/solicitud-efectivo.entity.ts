...
// import { SolicitudDesembolsoWebStatusEntity } from './solicitud-desembolso-web-status.entity';
...
export class SolicitudEfectivoEntity {
  ...
  // @ManyToOne(() => SolicitudDesembolsoWebStatusEntity)
  // @JoinColumn({ name: 'status_id' })
  // status: SolicitudDesembolsoWebStatusEntity;
